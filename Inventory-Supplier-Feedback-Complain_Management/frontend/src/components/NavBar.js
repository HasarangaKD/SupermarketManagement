  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <li class="nav-item active">
      ...
      <li class="nav-item dropdown " >
                        <a href="/list" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"style={{fontSize: "20px"}}>&#62; Inventory Item Details</a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="/c"style={{fontSize: "20px"}}> &#62; Compliants</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/feed"style={{fontSize: "20px"}}> &#62; Feedbacks</a>
      </li>
    </ul>
  </div>
</nav>
